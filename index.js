...
async function run() {
  try {
    ...
    */
     ...
     * 4.put them array
     * 5.seperate allOrderedItems by category using filter
     * 6. now get the quentity by using length: pizzas.length
     *  7. for each category using reduce to get the total ammount spent on this category 
     * 
     * 
     *  */
